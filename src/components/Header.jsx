...
const Header = () => {
  ...
  return (
    <div className="flex justify-between items-center w-full gap-6 p-8 bg-[#d9d9d9] border-b border-[#d9d9d9]">
      <Link to="/dashboard" className="flex items-center gap-6 cursor-pointer">
      ...
      <div className="flex justify-end items-center flex-grow gap-2">
        <Link
          to="/my-works"
          className="flex justify-center items-center gap-2 px-4 py-2 rounded-lg hover:bg-gray-300 transition-colors"
        >
          <p className="text-base text-[#1e1e1e]">Moje prace</p>
        </Link>
        <Link
          to="/my-checks"
          className="flex justify-center items-center gap-2 px-4 py-2 rounded-lg hover:bg-gray-300 transition-colors"
        >
          <p className="text-base text-[#1e1e1e]">Moje preverky</p>
        </Link>
        <Link
          to="/profile"
          className="flex justify-center items-center gap-2 px-4 py-2 rounded-lg hover:bg-gray-300 transition-colors"
        >
          <p className="text-base text-[#1e1e1e]">Profil</p>
        </Link>
        <button
          onClick={handleLogout}
          className="flex justify-center items-center gap-2 px-4 py-2 rounded-lg hover:bg-gray-300 transition-colors"
        >
          <p className="text-base text-[#1e1e1e]">Odhlásiť sa</p>
        </button>
      </div>
    </div>
  )
