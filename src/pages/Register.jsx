...
const Register = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Accept any valid email format and any non-empty password
    ...
    if (!emailRegex.test(trimmedEmail)) {
      alert('Prosím zadajte platný email (napr. user@example.com)')
      return
    }
  ...
  return (
    <div className="flex flex-col justify-start items-center min-h-screen w-full bg-[#2c2c2c]">
      <div className="flex justify-center items-center w-full gap-6 p-8 bg-[#d9d9d9] border-b border-[#d9d9d9]">
      ...
      <div className="flex flex-col justify-center items-center self-stretch flex-grow gap-8 px-6 py-40 bg-neutral-100">
        <div className="flex flex-col justify-start items-center gap-2">
          <h1 className="text-7xl font-bold text-center text-[#2c2c2c]">Registrácia</h1>
        </div>
        <form
          onSubmit={handleSubmit}
          className="flex flex-col justify-start items-start gap-6 p-6 rounded-lg bg-[#d9d9d9] border border-[#d9d9d9] shadow-lg"
        >
          <div className="flex flex-col justify-start items-start w-[272px] gap-2">
            <label className="text-base text-left text-[#1e1e1e] font-medium">Meno</label>
            <input
              type="text"
              value={name}
              onChange={(e) => setName(e.target.value)}
              className="flex justify-start items-center w-full px-4 py-3 rounded-lg bg-white border border-[#d9d9d9] text-base text-[#1e1e1e] focus:outline-none focus:ring-2 focus:ring-[#2c2c2c]"
              placeholder="Vaše meno"
              required
            />
          </div>
          <div className="flex flex-col justify-start items-start w-[272px] gap-2">
            <label className="text-base text-left text-[#1e1e1e] font-medium">Email</label>
            <input
              type="email"
              value={email}
          ...
          <div className="flex flex-col justify-start items-start w-[272px] gap-2">
            <label className="text-base text-left text-[#1e1e1e] font-medium">Heslo</label>
            <input
              type="password"
              value={password}
          ...
          <div className="flex justify-start items-center w-[272px] gap-4">
            <button
              type="submit"
              className="flex justify-center items-center flex-grow px-4 py-3 rounded-lg bg-neutral-100 border border-[#2c2c2c] text-base text-left text-[#1e1e1e] hover:bg-[#2c2c2c] hover:text-white transition-colors font-medium"
            >
              Registrovať sa
            </button>
          </div>
          <div className="flex justify-center items-center w-[272px]">
            <p className="text-sm text-[#1e1e1e]">
              Už máte účet?{' '}
              <Link to="/login" className="text-[#2c2c2c] font-semibold hover:underline">
                Prihlásiť sa
              </Link>
            </p>
          </div>
